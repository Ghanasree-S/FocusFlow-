...
class Config:
    ...
    # CORS
    CORS_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:5173,http://localhost:3000,https://chronosai-api.onrender.com,https://chronosai-frontend.onrender.com').split(',')
